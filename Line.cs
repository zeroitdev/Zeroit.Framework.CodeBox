...
// ***********************************************************************
// <copyright file="Line.cs" company="Zeroit Dev">
...
namespace Zeroit.Framework.CodeBox
{
    ...
    public class Line
    {
        ...
        /// </summary>
        /// <remarks>The line must be set as a <see cref="Zeroit.Framework.CodeBox.FoldLevelFlags.Header" />.</remarks>
        ...
        /// <see cref="Zeroit.Framework.CodeBox.FoldLevelFlags.Header" /> and has a <see cref="FoldLevel" /> less than the current line.
        /// </summary>
        ...
        public Line(ZeroitCodeExplorer Scintilla, int index)
        {
